...
import { unCamelCase, uppercaseFirstLetter, toTwoDecimal } from '../utils.js';
...
const RecommendedTransfers = (props) => {
  ...
  function generateRecommendedTransfers() {
    ...
    Object.entries(props.riskCalculator).map((category) => {
      ...
      <td className="risk-calculator--recommended" rowSpan="5">
        ...
        {props.incorrectAmountFormat
          ...
          : steps.map((step, index) => {
              return <div className="risk-calculator--recommended-item" key={index}>
